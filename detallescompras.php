						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="modal-title" id="myModalLabel">Datos de Detalle de Compras de Productos</h4>
						      </div>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Detalles de Compras de Productos</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Detalles de Compras de Productos</h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-info-circle'></span> ESTE DETALLE DE COMPRA NO PUEDE SER ELIMINADO, SE ENCUENTRA INACTIVO PARA ELIMINAR </div></center>"; 
		break;
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR DETALLES DE COMPRAS DE PRODUCTOS, NO ERES EL ADMINISTRADOR DEL SISTEMA </div></center>";  
		break;
	}
}		
	   ?> 
...
?>
                              <tr>
                                  ...
                                  <td><?php echo number_format($reg[$i]['precio1'], 2, '.', ','); ?></td>
                                  <td><?php echo $reg[$i]['cantcompra']; ?></td>
                                  <td>
<a href="#" title="Ver Detalle de Compras" onClick="VerDetalleCompra('<?php echo $reg[$i]['coddetallecompra'] ?>')" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>

<a href="#" class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editdetallecompras?coddetallecompra=<?php echo base64_encode($reg[$i]["coddetallecompra"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&coddetallecompra=<?php echo base64_encode($reg[$i]["coddetallecompra"]) ?>&codcompra=<?php echo base64_encode($reg[$i]["codcompra"]) ?>&codproducto=<?php echo base64_encode($reg[$i]["codproducto"]) ?>&cantcompra=<?php echo base64_encode($reg[$i]["cantcompra"]) ?>&ivaproductoc=<?php echo base64_encode($reg[$i]["ivaproductoc"]) ?>&tipo=<?php echo base64_encode("DETALLESCOMPRAS") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> 							  </td>
                              </tr>
												<?php  }  ?>
                              </tbody>
                          </table>
