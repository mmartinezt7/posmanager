      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Actualización para Detalle de Venta de Productos</h3><br>
			...
			<div class="row">
               ...
               <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Actualización de Detalle de Venta de Productos</h4> </div>
                                    <div class="panel-body">
<form class="form-horizontal" method="post"  action="#" name="updatedetallesventas" id="updatedetallesventas" data-id="<?php echo $reg[0]["coddetalleventa"] ?>">
						 ...
						 <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
			 <input type="hidden" name="coddetalleventa" id="coddetalleventa" value="<?php echo $reg[0]['coddetalleventa']; ?>">
			 ...
			 <input type="hidden" name="codcliente" id="codcliente" value="<?php echo $reg[0]['codcliente']; ?>">
                        ...
                        <i class="fa fa-pencil form-control-feedback"></i>
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10"> 
<input class="form-control" type="text" name="precioventa" id="precioventa" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $reg[0]['precioventa']; ?>" readonly="readonly">
<input type="hidden" name="preciocompra" id="preciocompra" value="<?php echo $reg[0]['preciocompra']; ?>" readonly="readonly">
<input  type="hidden" name="ivaproducto" id="ivaproducto" value="<?php echo $reg[0]['ivaproducto']; ?>"> <i class="fa fa-money form-control-feedback"></i>
                              </div>
                          </div>
						   ...
						   <div class="form-group has-feedback">
                              <label class="col-sm-2 col-sm-2 control-label">Cantidad Venta: <span class="symbol required"></span></label>
                              <div class="col-sm-10">
                                   <input class="form-control calculoventa" type="text" name="cantventa" id="cantventa" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Cantidad de Venta" value="<?php echo $reg[0]['cantventa']; ?>" required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i>
                              </div>
                          </div>	
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10"> 
<input class="form-control number" type="text" name="importe" id="importe" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Importe" value="<?php echo $reg[0]['importe']; ?>" readonly="readonly">

<input type="hidden" name="importe2" id="importe2" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" value="<?php echo $reg[0]['importe2']; ?>" > <i class="fa fa-money form-control-feedback"></i>
                              </div>
                          </div>		 
								
						  <div class="form-group has-feedback">
                              <label class="col-sm-2 col-sm-2 control-label">Fecha Venta: </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="fechadetalleventa" id="fechadetalleventa" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo date("d-m-Y h:i:s",strtotime($reg[0]['fechadetalleventa'])); ?>" readonly="readonly">
                        <i class="fa fa-calendar form-control-feedback"></i>
						  ...
						  <a href="detallesventas" class="btn btn-success"><span class="fa fa-mail-reply "></span> Regresar</a> 
                          </div>
                      </form>
                                  </div>
                                </div>
