						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="modal-title" id="myModalLabel">Datos de Factura de Devolución de Productos</h4>
						      </div>
						      <div class="modal-body">
                         <div id="muestradevolucionmodal"></div>
						      </div>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Devolución de Productos</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Devolución de Productos</h4> </div>
...
?>
                              <tr>
                                  ...
                                  <td><?php echo number_format($reg[$i]['subtotald'], 2, '.', ','); ?></td>
                                  <td><?php echo number_format($reg[$i]['totalivad'], 2, '.', ','); ?></td>
                                  <td><?php echo number_format($reg[$i]['totald'], 2, '.', ','); ?></td>
                                  <td><?php echo date("d-m-Y h:i:s",strtotime($reg[$i]['fechadevolucion'])); ?></td>
                                  <td>
<a href="#" title="Ver Factura de Devolución" data-id="<?php echo $reg[$i]['coddevolucion']; ?>" class="btn btn-success btn-xs verdevoluciones" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>
								 
<a href="reportepdf?coddevolucion=<?php echo base64_encode($reg[$i]['coddevolucion']); ?>&tipo=<?php echo base64_encode("DEVOLUCIONES") ?>" target="_black" class="btn btn-warning btn-xs" title="Factura de Venta" ><i class="fa fa-print"></i></a>
