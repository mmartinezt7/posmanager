      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Retiro de Efectivo de Caja</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Retiro de Efectivo de Caja<span class="pull-right"><a href="reportepdf.php?tipo=<?php echo base64_encode("RETIROEFECTIVO") ?>" target="_blank" class="btn btn-primary"><span class="fa fa-print"></span> Imprimir Listado</a>&nbsp;<a href="forretiro.php" class="btn btn-primary"><span class="fa fa-plus"></span> Nuevo Retiro</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-check-square-o'></span> EL RETIRO DE EFECTIVO EN CAJA FUE ELIMINADA EXITOSAMENTE </div></center>"; 
		break;
		
		case 2:
		echo "<center><div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> ESTE RETIRO DE EFECTIVO DE CAJA NO PUEDE SER ELIMINADO, HA PASADO LA FECHA DE REGISTRO </div></center>";  
		break;
...
?>
                              <tr>
                                  ...
                                  <td><?php echo $reg[$i]['motivoretiro']; ?></td>
                                  <td><?php echo number_format($reg[$i]['cantretiro'], 2, '.', '.'); ?></td>
                                  <td><?php echo date("d-m-Y h:i:s",strtotime($reg[$i]['fecharetiro'])); ?></td>
                                  <td>
<a href="#" class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editretiro?codretiro=<?php echo base64_encode($reg[$i]["codretiro"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codretiro=<?php echo base64_encode($reg[$i]["codretiro"]) ?>&tipo=<?php echo base64_encode("RETIROEFECTIVO") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> 
								  </td>
                              </tr>
												<?php  }  ?>
                              </tbody>
