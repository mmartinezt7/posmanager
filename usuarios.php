      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Usuarios</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Usuarios<span class="pull-right"><a href="forusuario" class="btn btn-primary"><span class="fa fa-plus"></span> Nuevo Usuario</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-check-square-o'></span> EL USUARIO FUE ELIMINADO EXITOSAMENTE </div></center>"; 
		break;
		
		case 2:
		echo "<center><div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> ESTE USUARIO NO PUEDE SER ELIMINADO, TIENE VENTAS RELACIONADAS ACTUALMENTE </div></center>";  
		break;
...
?>
                              <tr>
                                  ...
                                  <td><?php echo $status = ( $reg[$i]['status'] == 'ACTIVO' ? "<span class='label label-success'><i class='fa fa-check'></i> ACTIVO</span>" : "<span class='label label-warning'><i class='fa fa-times'></i> INACTIVO</span>"); ?></td>
                                  <td>
<a href="#" title="Ver Usuario" onClick="VerUsuario('<?php echo $reg[$i]['codigo'] ?>')" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editusuario?codigo=<?php echo base64_encode($reg[$i]["codigo"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codigo=<?php echo base64_encode($reg[$i]["codigo"]) ?>&tipo=<?php echo base64_encode("USUARIOS") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> 
								  </td>
                              </tr>
												<?php  }  ?>
                              </tbody>
