      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Registro de Retiro de Efectivo de Caja</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                               ...
                               <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Registro de Retiro de Efectivo de Caja</h4> </div>
...
############################# BUSQUEDA DE CAJAS DE VENTAS ######################################
			...
			for($i=0;$i<sizeof($caj);$i++){
		              ?>
<option value="<?php echo $caj[$i]['codcaja'] ?>"><?php echo $caj[$i]['nrocaja'].": ".$caj[$i]['nombrecaja'] ?></option>			  
                      <?php 
	}
...
?>
						   ...
						   <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                   <input class="form-control number" type="text" name="cantretiro" id="cantretiro" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Monto de Retiro" required="" aria-required="true">
                        <i class="fa fa-money form-control-feedback"></i>
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                   <textarea name="motivoretiro" class="form-control" id="motivoretiro" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Motivo de Retiro" required="" aria-required="true"></textarea>
                        <i class="fa fa-pencil form-control-feedback"></i>
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                 <input class="form-control" type="text" name="fecharetiro" id="fecharetiro" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Fecha de Retiro" value="<?php echo date("d-m-Y h:i:s A"); ?>" readonly="readonly"> 
                        <i class="fa fa-calendar form-control-feedback"></i>
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                 <input class="form-control" type="text" name="nombres" id="nombres" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Registrado por" value="<?php echo $_SESSION["nombres"]; ?>" readonly="readonly"> 
