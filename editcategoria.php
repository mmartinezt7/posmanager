      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Actualización de Categorias</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Actualización de Categorias</h4> </div>
                                    <div class="panel-body">
								   
<form class="form-horizontal" name="updatecategoria" id="updatecategoria" method="post" data-id="<?php echo $reg[0]["codcategoria"] ?>" action="#">

                                                  <div id="error">
                                                 <!-- error will be shown here ! -->
                                                     </div>   
						 <div class="form-group has-feedback">
                              <label class="col-sm-2 col-sm-2 control-label">Nombre de Categoria: <span class="symbol required"></span></label>
                              <div class="col-sm-10">
			 <input type="hidden" name="codcategoria" id="codcategoria" value="<?php echo $reg[0]['codcategoria']; ?>">
             <input type="text" class="form-control" name="nomcategoria" id="nomcategoria" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Categoria" value="<?php echo $reg[0]['nomcategoria']; ?>" required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i>
						  ...
						  <a href="categorias" class="btn btn-success"><span class="fa fa-mail-reply "></span> Regresar</a> 
                          </div>
                      </form>
                                  </div>
                                </div>
