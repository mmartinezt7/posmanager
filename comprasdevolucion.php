      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Búsqueda de Devolución de Productos por Proveedores</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Búsqueda de Devolución de Productos por Proveedor</h4> </div>
				...
				<form class="form-horizontal" method="post"  action="#" name="buscadevolucionesreportes" id="buscadevolucionesreportes">
						 ...
						 <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
             <select name="codproveedor" id="codproveedor" class='form-control devoluciones' required="" aria-required="true">
