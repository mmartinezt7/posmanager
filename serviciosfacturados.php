      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Búsqueda de Servicios Facturados por Fechas</h3><br>
			...
			<div class="row">
                       ...
                       <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Búsqueda de Servicios Facturados por Fechas</h4> </div>
                                    <div class="panel-body">
				<form class="form-horizontal" method="post"  action="#" name="buscaservicios" id="buscaservicios">
...
<button type="button" name="buscarservicios" id="buscarservicios" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button> 
                          </div>
