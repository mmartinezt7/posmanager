						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="modal-title" id="myModalLabel">Datos de Factura de Pedido de Productos</h4>
						      </div>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Pedidos de Productos</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Pedidos de Productos</h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> ESTE PEDIDO DE PRODUCTO NO PUEDE SER ELIMINADO, TIENE VENTAS RELACIONADAS ACTUALMENTE </div></center>";  
		break;
...
?>
                              <tr>
                                  ...
                                  <td>
<a href="#" title="Ver Factura de Pedido" data-id="<?php echo $reg[$i]['codpedido']; ?>" class="btn btn-success btn-xs verpedidos" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>
								 
<a href="reportepdf?codpedido=<?php echo base64_encode($reg[$i]['codpedido']); ?>&tipo=<?php echo base64_encode("PEDIDOS") ?>" target="_black" class="btn btn-warning btn-xs" title="Factura de Pedido" ><i class="fa fa-print"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codpedido=<?php echo base64_encode($reg[$i]["codpedido"]) ?>&tipo=<?php echo base64_encode("PEDIDOS") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> 
								  </td>
                              </tr>
												<?php  }  ?>
                              </tbody>
