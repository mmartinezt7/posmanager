      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Logs de Usuarios</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Logs de Usuarios<span class="pull-right"><a href="reportepdf?tipo=<?php echo base64_encode("LOGS") ?>" target="_blank" class="btn btn-primary"><span class="fa fa-print"></span> Imprimir Listado</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4> </div>
