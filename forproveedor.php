...
<html lang="en">
  <head>
	...
	$("#tlfproveedor").mask("(9999) 999-9999");
	});
	</script>
			...
			<div class="row">
				...
				<form class="form-horizontal" method="post"  action="#" name="proveedores" id="proveedores">
						 ...
						 <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="ritproveedor" id="ritproveedor" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Rif de Proveedor" required="" aria-required="true">
