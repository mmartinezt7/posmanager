...
$reg = $tra->ListarDetallesServicios();
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="modal-title" id="myModalLabel">Datos de Detalle de Servicio</h4>
						      </div>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Detalles de Facturas de Servicios</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Detalles de Facturas de Servicios</h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-check-square-o'></span> EL DETALLE DE SERVICIO FUE ELIMINADO EXITOSAMENTE </div></center>"; 
		break;
		
		case 2:
		echo "<center><div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR DETALLES DE SERVICIOS EN FACTURA, NO ERES EL ADMINISTRADOR DEL SISTEMA </div></center>";  
		break;
...
?>
                              <tr>
                                  ...
                                  <td><?php echo number_format($reg[$i]['precioservicio'], 2, '.', '.'); ?></td>
                                  <td><?php echo $reg[$i]['cantservicio']; ?></td>
                                  <td><?php echo $reg[$i]['importe']; ?></td>
                                  <td>
<a href="#" title="Ver Detalle de Servicio" onClick="VerDetalleServicio('<?php echo $reg[$i]['coddetalleservicio'] ?>')" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>

<a href="#" class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editdetalleservicios?coddetalleservicio=<?php echo base64_encode($reg[$i]["coddetalleservicio"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&coddetalleservicio=<?php echo base64_encode($reg[$i]["coddetalleservicio"]) ?>&codservicio=<?php echo base64_encode($reg[$i]["codservicio"]) ?>&coditems=<?php echo base64_encode($reg[$i]["coditems"]) ?>&cantservicio=<?php echo base64_encode($reg[$i]["cantservicio"]) ?>&tipo=<?php echo base64_encode("DETALLESSERVICIOS") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> 							  </td>
                              </tr>
												<?php  }  ?>
                              </tbody>
                          </table>
