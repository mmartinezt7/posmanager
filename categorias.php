     ...
     <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Categorias</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Categorias<span class="pull-right"><a href="forcategoria.php" class="btn btn-primary"><span class="fa fa-plus"></span> Nueva Categoria</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-check-square-o'></span> LA CATEGORIA DE PRODUCTO FUE ELIMINADA EXITOSAMENTE </div></center>"; 
		break;
		
		case 2:
		echo "<center><div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> ESTA CATEGORIA NO PUEDE SER ELIMINADA, TIENE PRODUCTOS RELACIONADAS ACTUALMENTE </div></center>";  
		break;
...
?>
                              <tr>
                                  ...
                                  <td>
<a href="#" class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editcategoria?codcategoria=<?php echo base64_encode($reg[$i]["codcategoria"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codcategoria=<?php echo base64_encode($reg[$i]["codcategoria"]) ?>&tipo=<?php echo base64_encode("CATEGORIAS") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> 
								  </td>
                              </tr>
												<?php  }  ?>
                              </tbody>
