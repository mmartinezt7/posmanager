      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Búsqueda de Ventas por Fechas y Cajas de Ventas</h3><br>
			...
			<div class="row">
                        ...
                        <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Búsqueda de Ventas por Fechas y Cajas de Ventas</h4> </div>
                                    <div class="panel-body">
				<form class="form-horizontal" method="post"  action="#" name="buscaventacaja" id="buscaventacaja">
...
<option value="<?php echo $ca[$i]['codcaja'] ?>"><?php echo "Caja: ".$ca[$i]['nrocaja'] ?> - <?php echo $ca[$i]['nombres'] ?></option>			  
  ...
  <button type="button" name="buscarventascajas" id="buscarventascajas" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button> 
                          </div>
