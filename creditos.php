						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="modal-title" id="myModalLabel">Datos de Factura de Venta de Créditos</h4>
						      </div>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Créditos de Ventas de Productos</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Créditos de Ventas de Productos</h4> </div>
...
?>
                              <tr>
                                  ...
                                  <td><?php echo number_format($reg[$i]['abonototal'], 2, '.', ','); ?></td>
                                  <td><?php echo number_format($reg[$i]["totalpago"]-$reg[$i]["abonototal"], 2, '.', ','); ?></td>
                                  <td>
<a href="#" title="Ver Abono de Crédito" onClick="VerCreditos('<?php echo $reg[$i]['codventa'] ?>')" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>
								 
<a href="reportepdf?codventa=<?php echo base64_encode($reg[$i]['codventa']); ?>&tipo=<?php echo base64_encode("TICKETCREDITOS") ?>" target="_black" class="btn btn-info btn-xs" title="Ticket de Venta" ><i class="fa fa-print"></i></a>
