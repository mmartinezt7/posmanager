...
{
$reg = $tra->ActualizarDetallesPedidos();
exit;
}
?>
<!DOCTYPE html>
      ...
      <header class="header black-bg">
            ...
            <div class="nav notify-row" id="top_menu">
				...
				<?php } ?>	
                   ...
                   <!-- settings end -->
      <i style='font-weight:bold; font-size:16px;' id="spanreloj"></i>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Actualización para Detalle de Pedido de Productos</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Actualización de Detalle de Pedido de Productos</h4> </div>
                                    <div class="panel-body">
<form class="form-horizontal" method="post"  action="#" name="updatedetallespedidos" id="updatedetallespedidos" data-id="<?php echo $reg[0]["coddetallepedido"] ?>">

                                                  <div id="error">
                                                 <!-- error will be shown here ! -->
                                                     </div>   
						 <div class="form-group has-feedback">
			 <input type="hidden" name="coddetallepedido" id="coddetallepedido" value="<?php echo $reg[0]['coddetallepedido']; ?>">
                              <label class="col-sm-2 col-sm-2 control-label">Código Producto: <span class="symbol required"></span></label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="codproducto" id="codproducto" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Código de Producto" value="<?php echo $reg[0]['codproducto']; ?>" required="" aria-required="true">
	...
	<option value="<?php echo $cat[$i]['codcategoria']; ?>"<?php if (!(strcmp($reg[0]['codcategoria'], htmlentities($cat[$i]['codcategoria'])))) {echo "selected=\"selected\"";} ?>><?php echo $cat[$i]['nomcategoria']; ?></option>			  
                      <?php } ?>
						   ...
						   <div class="form-group has-feedback">
                              <label class="col-sm-2 col-sm-2 control-label">Cantidad Pedido: <span class="symbol required"></span></label>
                              <div class="col-sm-10">
                                   <input class="form-control number" type="text" name="cantpedido" id="cantpedido" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Cantidad de Pedido" value="<?php echo $reg[0]['cantpedido']; ?>" required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i>
                              </div>
                          </div>
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="fechadetallepedido" id="fechadetallepedido" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo date("d-m-Y h:i:s",strtotime($reg[0]['fechadetallepedido'])); ?>" readonly="readonly">
                        <i class="fa fa-calendar form-control-feedback"></i>
						  ...
						  <a href="detallespedidos" class="btn btn-success"><span class="fa fa-mail-reply "></span> Regresar</a> 
                          </div>
                      </form>
                                  </div>
                                </div>
