      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Búsqueda de Abonos a Créditos por Fechas</h3><br>
          	
          	<!-- BASIC FORM ELELEMNTS -->
			
			<div class="row">
								   <form class="form-horizontal" method="post"  action="#" name="creditosfechasreportes" id="creditosfechasreportes">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                            <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Búsqueda de Créditos Pendientes por Fechas</h4> </div>
...
<button type="button" onClick="BuscaCreditosFechasReportes()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button> 
                          </div>
                                  </div>
                                </div>
						<div id="muestracreditosfechasreportes"></div>		
                            </div>
                      </form>
						 </div>
