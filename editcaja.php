      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Actualización de Cajas de Ventas</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Actualización de Cajas de Ventas</h4> </div>
                                    <div class="panel-body">
	         <form class="form-horizontal" name="updatecajas" id="updatecajas" method="post" data-id="<?php echo $reg[0]["codcaja"] ?>">
                                                  <div id="error">
			 ...
			 <input type="hidden" name="codcaja" id="codcaja" value="<?php echo $reg[0]['codcaja']; ?>">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="nrocaja" id="nrocaja" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese N° de Caja" value="<?php echo $reg[0]['nrocaja']; ?>" readonly="readonly" aria-required="true">
                        <i class="fa fa-desktop form-control-feedback"></i>
						   ...
						   <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="nombrecaja" id="nombrecaja" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Caja" value="<?php echo $reg[0]['nombrecaja']; ?>" required="" aria-required="true">
                        <i class="fa fa-desktop form-control-feedback"></i>
                              </div>
                          </div>
...
############################# BUSQUEDA DE USUARIOS ######################################
			...
			for($i=0;$i<sizeof($usu);$i++){
		              ?>
<option value="<?php echo $usu[$i]['codigo'] ?>"<?php if ($usu[$i]['codigo'] == $reg[0]['codigo']) { ?> selected="selected" <?php } ?>><?php echo $usu[$i]['nombres'] ?></option>		  
                      <?php 
	}
