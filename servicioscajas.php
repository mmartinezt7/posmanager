      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Búsqueda de Servicios por Fechas y Cajas de Ventas</h3><br>
			...
			<div class="row">
                        ...
                        <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Búsqueda de Servicios por Fechas y Cajas de Ventas</h4> </div>
                                    <div class="panel-body">
				<form class="form-horizontal" method="post"  action="#" name="buscaserviciocaja" id="buscaserviciocaja">
                        ...
                        <i class="fa fa-calendar form-control-feedback"></i>
						   ...
						   <div class="form-group has-feedback">
                              <label class="col-sm-3 col-sm-3 control-label">Seleccione Caja de Venta: <span class="symbol required"></span></label>
                              <div class="col-sm-9">
			...
			for($i=0;$i<sizeof($ca);$i++){
		              ?>
<option value="<?php echo $ca[$i]['codcaja'] ?>"><?php echo "Caja: ".$ca[$i]['nrocaja'] ?> - <?php echo $ca[$i]['nombres'] ?></option>			  
           <?php } ?>
							    </select> 
                              </div>
                          </div>
  ...
  <button type="button" name="buscarservicioscajas" id="buscarservicioscajas" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button> 
                          </div>
						  
                      </form>
                                  </div>
                                </div>
											<div id="muestraservicioscajas"></div>
                            </div>
						 </div>
