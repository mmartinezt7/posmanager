      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="logout.php"><i class="fa fa-power-off"></i> Salir</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo de Gráficos de Servicios por Meses</h3><br>
          	
          	<!-- BASIC FORM ELELEMNTS -->
<?php
$servicio = new Login();
$servicio = $servicio->GraficoServicios();
?>				
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                       <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Gráficos Estadistico de Servicios por Meses</h4> </div>
...
legend(document.getElementById("barLegend"), data, barChart, "<%=label%> ");</script>	
                                  </div>
                                </div>
                            </div>
						 </div>
