      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Búsqueda de Créditos por Clientes</h3><br>
          	
          	<!-- BASIC FORM ELELEMNTS -->
			
			<div class="row">
								   <form class="form-horizontal" method="post"  action="#" name="creditosclientesreportes" id="creditosclientesreportes">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Búsqueda de Créditos por Clientes</h4> </div>
					...
					<div class="form-group has-feedback">
                              <label class="col-sm-2 col-sm-2 control-label">Búsqueda de Clientes: <span class="symbol required"></span></label>
                              <div class="col-sm-10">
                                  <input type="hidden" class="form-control" name="codcliente" id="codcliente"><input class="form-control" type="text" name="busqueda" id="busqueda" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Datos del Cliente para tu busqueda" required="required">
                        <i class="fa fa-pencil form-control-feedback"></i>
                              </div>
                          </div>
						                           
						  <div class="modal-footer"> 
<button type="button" onClick="BuscaCreditosClientesReportes()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button> 
                          </div>
                                  </div>
                                </div>
						<div id="muestracreditosclientesreportes"></div>		
                            </div>
                      </form>
						 </div>
