      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Actualización de Datos de Acceso</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Actualizar Datos de Acceso</h4> </div>
                                    <div class="panel-body">
		<form class="form-horizontal" method="post" data-id="<?php echo $_SESSION["codigo"]?>" action="#" name="updatepassword" id="updatepassword">
						 ...
						 <div class="form-group has-feedback">
							 ...
							 <input name="codigo" type="hidden" value="<?php echo $_SESSION['codigo']; ?>" id="codigo" /> 
                                  <input type="text" class="form-control" name="cedula" id="cedula" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Cédula de Usuario" value="<?php echo $_SESSION['cedula']; ?>" readonly="readonly">
                        <i class="fa fa-pencil form-control-feedback"></i>
						    ...
						    <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="usuario" id="usuario" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Usuario de Acceso" value="<?php echo $_SESSION['usuario']; ?>" required="" aria-required="true">
