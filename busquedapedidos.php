      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Búsqueda de Pedidos de Productos por Proveedores</h3><br>
          	
          	<!-- BASIC FORM ELELEMNTS -->
			
			<div class="row">
						    <div class="col-lg-12">
				<form class="form-horizontal" method="post"  action="#" name="buscapedidosreportes" id="buscapedidosreportes">
                                <div class="panel panel-border panel-warning widget-s-1">
                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Búsqueda de Pedidos de Productos por Proveedor</h4> </div>
...
<button type="button" onClick="BuscaPedidosProductos()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button> 
                          </div>
                                  </div>
                                </div>	
